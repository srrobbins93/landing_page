//Generated:2021-12-03 16:01:10// 39-518
(function() {
  var o = {
    $: function(el) {
      var x = el || o.divID,
  ...
  var data = {
    ...
    creativeID: '3635426',
    exttrack: [
      'https://dpm.demdex.net/ibs:dpid=3047&dpuuid=[%FT_GUID%]&','https://d.agkn.com/pixel/4068/?che=[%FT_RANDOM%]&aid=12345&cvid=[%FT_CONFID%]&cd1=[%esid!]&cd2=[%epid!]&col=140402,6060,5183710,0,3635426,[%FT_IMPRESSIONID%],[%IDFA%]&puid=[%FT_GUID%]'
    ],
    extscript: [
      ""
    ],
    clickTags: [
      "http://servedby.flashtalking.com/click/8/140402;5183710;3635426;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://d.agkn.com/pixel/4069/?che=[%FT_RANDOM%]&aid=12345&cvid=[%FT_CONFID%]&cd1=[%esid!]&cd2=[%epid!]&col=140402,6060,5183710,0,3635426,[%FT_IMPRESSIONID%],[%IDFA%]&l0=https://www.xfinity.com/learn/internet-service/deals?dfaid=4053494&cmp=0&cid=4053494"
    ],
    ...
    altText: 'Click here',
    altImgTarget: '_blank',
    altimghref: 'http://servedby.flashtalking.com/click/8/140402;5183710;3635426;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://d.agkn.com/pixel/4069/?che=[%FT_RANDOM%]&aid=12345&cvid=[%FT_CONFID%]&cd1=[%esid!]&cd2=[%epid!]&col=140402,6060,5183710,0,3635426,[%FT_IMPRESSIONID%],[%IDFA%]&l0=https://www.xfinity.com/learn/internet-service/deals?dfaid=4053494&cmp=0&cid=4053494',
    ...
    jsurl: 'http://cdn.flashtalking.com/xre/518/5183710/3635426/js/j-5183710-3635426.js',
    file: 'http://cdn.flashtalking.com/110416/3635426/index.html',
    safeFrame: window.$sf && window.$sf.ext || false,
    serveDOM: 'http://cdn.flashtalking.com',
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?215332120-5183710;3635426;',
    adVis: false ? 1 : 0,
    centreAd: false,
    mvt: true,
